...
def clean_file(base_dir):
    ...
    size_file_path = f"{base_dir}/step3_size.str"
    equil_file_path = f"{base_dir}/namd/step6.1_equilibration.inp"
    ...
    namd_files = [
            f"{base_dir}/namd/step6.1_equilibration.inp",
            f"{base_dir}/namd/step6.2_equilibration.inp",
            f"{base_dir}/namd/step6.3_equilibration.inp",
            f"{base_dir}/namd/step6.4_equilibration.inp",
            f"{base_dir}/namd/step6.5_equilibration.inp",
            f"{base_dir}/namd/step6.6_equilibration.inp",
            f"{base_dir}/namd/step7_production.inp" 
            ]
...
def rmsd_rmsf_solution_case(base_dir, output_folder='simulation_output'):
    ...
    # Define File Paths
    # -------------------------
    topology_file = os.path.join(base_dir, 'namd', 'step5_input.psf')
    prod_traj_file = os.path.join(base_dir, 'namd', 'step7_production.dcd')
...
def sasa_solution_case(base_dir, selection="protein"):
    ...
    """
    # File paths
    dcd_file = f"{base_dir}/namd/step7_production.dcd"
    psf_file = f"{base_dir}/namd/step5_input.psf"
    output_dir = base_dir
...
def radius_of_gyration_solution_case(base_dir):
    # Define file paths
    psf_file = os.path.join(base_dir, "namd", "step5_input.psf")
    dcd_file = os.path.join(base_dir, "namd", "step7_production.dcd")
